...
// The jQuery module is only used for interacting with bustrap 4. It can we removed when MDL-71979 is integrated.
...
const disableButtonTooltip = (button, enableOnBlur) => {
    if (button.hasAttribute('data-original-title')) {
        // The jQuery is still used in bustrap 4. It can we removed when MDL-71979 is integrated.
...
export default class Drawers {
     ...
     *
     * @static
     * @property {String} drawerShow See {@link event:theme_bust/drawers:show}
     * @property {String} drawerShown See {@link event:theme_bust/drawers:shown}
     * @property {String} drawerHide See {@link event:theme_bust/drawers:hide}
     * @property {String} drawerHidden See {@link event:theme_bust/drawers:hidden}
     */
    static eventTypes = {
        /**
         * An event triggered before a drawer is shown.
         *
         * @event theme_bust/drawers:show
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be opened.
         */
        drawerShow: 'theme_bust/drawers:show',

        /**
         * An event triggered after a drawer is shown.
         *
         * @event theme_bust/drawers:shown
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be opened.
         */
        drawerShown: 'theme_bust/drawers:shown',

        /**
         * An event triggered before a drawer is hidden.
         *
         * @event theme_bust/drawers:hide
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be hidden.
         */
        drawerHide: 'theme_bust/drawers:hide',

        /**
         * An event triggered after a drawer is hidden.
         *
         * @event theme_bust/drawers:hidden
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be hidden.
         */
        drawerHidden: 'theme_bust/drawers:hidden',
    };
     ...
     * @returns {module:theme_bust/drawers}
     */
    ...
    openDrawer({focusOnCloseButton = true, setUserPref = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_bust/drawers:open');
    ...
    closeDrawer({focusOnOpenButton = true, updatePreferences = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_bust/drawers:close');
     ...
     *
     * @param {module:theme_bust/drawers} comparisonInstance
     */
