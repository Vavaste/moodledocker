...
* remove folder theme/bust/scss/bootstrap
* copy the scss files from ~/bootstrap/scss to theme/bust/scss/bootstrap
...
* comment out this line in theme/bust/scss/_print.scss
    @page {
...
* remove folder theme/bust/amd/src/bootstrap
* copy the js files from ~/bootstrap/js/src to theme/bust/amd/src/bootstrap (including the subfolder)
* copy index.js from ~/bootstrap/js to theme/bust/amd/src
* edit theme/bust/amd/src/index.js and update import path (src -> bootstrap)
...
* in folder theme/bust run "grunt amd" to compile the bootstrap JS
* in folder theme/bust run "grunt css" to compile scss
