...
2. SCSS:
  a. Replace the files in this folder (/theme/bust/scss/fontawesome) with the files in the scss folder.
  b. Copy the LICENSE.txt file from the root to theme/bust/scss/fontawesome.
  c. Update theme/bust/thirdpartylibs.xml.
