...
/**
 * Creates a navbar for bust that allows easy control of the navbar items.
 *
 * @package    theme_bust
...
class boostnavbar implements \renderable {
    ...
    public function __construct(\moodle_page $page) {
        ...
        $this->prepare_nodes_for_bust();
    }

    /**
     * Prepares the navigation nodes for use with bust.
     */
    protected function prepare_nodes_for_bust(): void {
        global $PAGE;
